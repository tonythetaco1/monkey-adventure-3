...
function animateCrouch () {
    ...
    mainCrouchLeft.addAnimationFrame(img`
        ...
        . . f d d d d e e e f . . . . . 
        . . f d d d f d e e f f . . . . 
        . c d d d d f d e e d d f . . . 
        c d e e d d f d e e b d c . . . 
    ...
    mainCrouchRight.addAnimationFrame(img`
        ...
        . . . . . f e e e d d d d f . . 
        . . . . f f e e d f d d d f . . 
        . . . f d d e e d f d d d d c . 
        . . . c d b e e d f d d e e d c 
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`orb`, function (sprite, location) {
    info.changeLifeBy(1)
    currentLevel += 1
    if (hasNextLevel()) {
...
function initializeLevel (level: number) {
    ...
    playerStartLocation = tiles.getTilesByType(assets.tile`tile0`)[0]
...
hero = sprites.create(assets.image`monke`, SpriteKind.Player)
...
forever(function () {
    music.playMelody("C D E D F E D E ", 120)
})
